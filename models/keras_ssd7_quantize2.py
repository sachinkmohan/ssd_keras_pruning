...
def build_model_quantize2(image_size,
                n_classes,
                mode='training',
    ...
    x1 = tfmot.quantization.keras.quantize_annotate_layer(Lambda(identity_layer, output_shape=(img_height, img_width, img_channels), name='identity_layer'), DefaultDenseQuantizeConfig())(x)
    if not (subtract_mean is None):
        #x1 = Lambda(input_mean_normalization, output_shape=(img_height, img_width, img_channels), name='input_mean_normalization')(x1)
        x1 = tfmot.quantization.keras.quantize_annotate_layer(Lambda(input_mean_normalization, output_shape=(img_height, img_width, img_channels), name='input_mean_normalization'), DefaultDenseQuantizeConfig())(x1)
    if not (divide_by_stddev is None):
        #x1 = Lambda(input_stddev_normalization, output_shape=(img_height, img_width, img_channels), name='input_stddev_normalization')(x1)
        x1 = tfmot.quantization.keras.quantize_annotate_layer(Lambda(input_stddev_normalization, output_shape=(img_height, img_width, img_channels), name='input_stddev_normalization'), DefaultDenseQuantizeConfig())(x1)
    if swap_channels:
        #x1 = Lambda(input_channel_swap, output_shape=(img_height, img_width, img_channels), name='input_channel_swap')(x1)
        x1 = tfmot.quantization.keras.quantize_annotate_layer(Lambda(input_channel_swap, output_shape=(img_height, img_width, img_channels), name='input_channel_swap'), DefaultDenseQuantizeConfig())(x1)
    ...
    conv1 = tfmot.quantization.keras.quantize_annotate_layer(ELU(name='elu1'), DefaultDenseQuantizeConfig())(conv1)
    ...
    conv2 = tfmot.quantization.keras.quantize_annotate_layer(ELU(name='elu2'), DefaultDenseQuantizeConfig())(conv2)
    ...
    conv3 = tfmot.quantization.keras.quantize_annotate_layer(ELU(name='elu3'), DefaultDenseQuantizeConfig())(conv3)
    ...
    conv4 = tfmot.quantization.keras.quantize_annotate_layer(ELU(name='elu4'), DefaultDenseQuantizeConfig())(conv4)
    ...
    conv5 = tfmot.quantization.keras.quantize_annotate_layer(ELU(name='elu5'), DefaultDenseQuantizeConfig())(conv5)
    ...
    conv6 = tfmot.quantization.keras.quantize_annotate_layer(ELU(name='elu6'), DefaultDenseQuantizeConfig())(conv6)
    ...
    conv7 = tfmot.quantization.keras.quantize_annotate_layer(ELU(name='elu7'), DefaultDenseQuantizeConfig())(conv7)
